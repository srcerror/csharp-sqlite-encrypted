...
*/
    ...
    // -------------- Logging from printf file -------------------------------
    /*
** A version of printf() that understands %lld.  Used for debugging.
** The printf() built into some versions of windows does not understand %lld
** and segfaults if you give it a long long int.
*/
    static void sqlite3DebugPrintf(string zFormat, params object[] ap)
    {
      var acc = string.Format(zFormat, ap);
      //#if !SQLITE_WINRT
      Debug.WriteLine(acc);
      //#endif
    }
    ...
    */
    static void sqlite3_log(int iErrCode, string zFormat, params object[] ap)
    {
    ...
    */
    ...
    {
      string acc = string.Format(zFormat, ap);
      sqlite3GlobalConfig.xLog(sqlite3GlobalConfig.pLogArg, iErrCode, acc);
    }
