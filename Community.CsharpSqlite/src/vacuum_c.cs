...
*/
    static int vacuumFinalize( sqlite3 db, sqlite3_stmt pStmt, ref string pzErrMsg )
    {
      int rc;
...
*/
    static int execSql( sqlite3 db, ref string pzErrMsg, string zSql )
    {
...
sqlite3_step(pStmt);
#endif
      return vacuumFinalize( db, pStmt, ref pzErrMsg );
    }
    ...
    */
    static int execExecSql( sqlite3 db, ref string pzErrMsg, string zSql )
    {
      sqlite3_stmt pStmt = null;
      int rc;
      ...
      {
        rc = execSql( db, ref pzErrMsg, sqlite3_column_text( pStmt, 0 ) );
        if ( rc != SQLITE_OK )
        {
          vacuumFinalize( db, pStmt, ref pzErrMsg );
          return rc;
        }
      }
    ...
    */
    static int sqlite3RunVacuum( ref string pzErrMsg, sqlite3 db )
    {
      ...
      */
      ...
      rc = execSql( db, ref pzErrMsg, zSql );
      if ( db.nDb > nDb )
      {
        pDb = db.aDb[db.nDb - 1];
      ...
      ** cause problems for the call to BtreeSetPageSize() below.  */
      ...
      rc = execSql( db, ref pzErrMsg, "PRAGMA vacuum_db.synchronous=OFF" );
      if ( rc != SQLITE_OK )
      {
        goto end_of_vacuum;
      }
      ...
      /* Begin a transaction */
      rc = execSql( db, ref pzErrMsg, "BEGIN EXCLUSIVE;" );
      if ( rc != SQLITE_OK )
        goto end_of_vacuum;
      ...
      */
      rc = execExecSql( db, ref pzErrMsg,
