...
static void PAGERTRACE( string format, params object[] ap ) { if ( sqlite3PagerTrace ) Debug.WriteLine( format, ap ); }
#else
    //#define PAGERTRACE(X)
    static void PAGERTRACE( string format, params object[] ap )
    {
    }
#endif
...
0==MEMDB
 ...
 pPager.memDb == 0
      ...
      PAGERTRACE( "PLAYBACK {0} page {1} hash({2:x}) {3}\n",
...
#endif
      IOTRACE( "PGIN {0} {1}\n", pPager, pgno );
      PAGERTRACE( "FETCH {0} page {1} hash({2:x})\n",
        ...
        */
        if ( pList.pgno <= pPager.dbSize && 0 == ( pList.flags & PGHDR_DONT_WRITE ) )
        {
          ...
          */
          ...
          PAGERTRACE( "STORE {0} page {1} hash({2:x})\n",
      ...
      if ( pPager.journalMode != PAGER_JOURNALMODE_OFF )
      {
        ...
        ** write the journal record into the file.  */
        if ( rc == SQLITE_OK )
        {
          ...
          PAGERTRACE( "STMT-JOURNAL {0} page {1}\n", PAGERID( pPager ), pPg.pgno );
        ...
        */
        if ( !pageInJournal( pPg ) && !pagerUseWal( pPager ) )
        {
...
#endif
#endif
            PAGERTRACE( "JOURNAL {0} page {1} needSync={2} hash({3:x})\n",
            PAGERID( pPager ), pPg.pgno,
          ...
          else
          {
            ...
            PAGERTRACE( "APPEND {0} page {1} needSync={2}\n",
            PAGERID( pPager ), pPg.pgno,
...
*/
    static void sqlite3PagerDontWrite( PgHdr pPg )
    {
      ...
      {
        PAGERTRACE( "DONT_WRITE page {0} of {1}\n", pPg.pgno, PAGERID( pPager ) );
        IOTRACE( "CLEAN {0} {1}\n", pPager, pPg.pgno );
 ...
 0 == pPager.memDb
    ...
    */
    ...
    )
    {
      ...
      PAGERTRACE( "DATABASE SYNC: File={0} zMaster={1} nSize={2}\n",
