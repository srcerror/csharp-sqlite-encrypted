    ...
    */
    static int yy_pop_parser_stack( yyParser pParser )
    {
      ...
      ** empty in SQLite.  */
      ...
      {
        fprintf( yyTraceFILE, "{0}Popping {1}\n",
        yyTracePrompt,
      ...
      if ( i < 0 || i >= YY_ACTTAB_COUNT || yy_lookahead[i] != iLookAhead )
      {
        if ( iLookAhead > 0 )
        {
          ...
          && ( iFallback = yyFallback[iLookAhead] ) != 0 )
          {
            ...
            if ( yyTraceFILE != null )
            {
              fprintf( yyTraceFILE, "{0}FALLBACK {1} => {2}\n",
...
return;
      ...
      {
        int i;
        fprintf( yyTraceFILE, "{0}Shift {1}\n", yyTracePrompt, yyNewState );
        fprintf( yyTraceFILE, "{0}Stack:", yyTracePrompt );
        for ( i = 1; i <= yypParser.yyidx; i++ )
          fprintf( yyTraceFILE, " {0}", yyTokenName[yypParser.yystack[i].major] );
        fprintf( yyTraceFILE, "\n" );
      }
#endif
    }
    ...
    */
    ...
    )
    {
      ...
      { //(int)(yyRuleName.Length/sizeof(yyRuleName[0])) ){
        fprintf( yyTraceFILE, "{0}Reduce [{1}].\n", yyTracePrompt,
        yyRuleName[yyruleno] );
      }
#endif // * NDEBUG */
