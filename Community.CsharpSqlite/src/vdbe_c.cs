...
*/
    static void memTracePrint(FILE _out, Mem p)
    {
      ...
      else if ((p.flags & (MEM_Int | MEM_Str)) == (MEM_Int | MEM_Str))
      {
        ...
        _out.Write(" si:{0}", p.u.i);
#if !SQLITE_OMIT_FLOATING_POINT
      }
      else if ((p.flags & MEM_Int) != 0)
      {
        _out.Write(" i:{0}", p.u.i);
#endif
      }
        ...
        */
        ...
        if (p.trace != null)
        {
          if (pc == 0)
          {
            ...
            Debug.WriteLine("VDBE Execution Trace:");
          ...
          case OP_Halt:
            {
              ...
              if (pOp.p4.z != null)
              {
                ...
                p.zErrMsg = string.Format("{0}", pOp.p4.z);
                testcase(sqlite3GlobalConfig.xLog != null);
                sqlite3_log(pOp.p1, "abort at {0} in [{1}]: {2}", pc, p.zSql, pOp.p4.z);
              }
              else if (p.rc != 0)
              {
                testcase(sqlite3GlobalConfig.xLog != null);
                sqlite3_log(pOp.p1, "constraint failed at {0} in [{1}]", pc, p.zSql);
              }
          ...
          case OP_Function:
            {
              ...
              */
              ...
              if (ctx.isError != 0)
              {
                ...
                p.zErrMsg = sqlite3_value_text(ctx.s);
                rc = ctx.isError;
              }
              ...
              else
              {
                ...
                ** an error is returned to the user.  */
                ...
                if (null == pSavepoint)
                {
                  ...
                  p.zErrMsg = string.Format("no such savepoint: {0}", zName);
                  rc = SQLITE_ERROR;
                }
                else if (
                ...
                )
                {
                  ...
                  */
                  ...
                  p.zErrMsg = string.Format("cannot {0} savepoint - SQL statements in progress",
          ...
          case OP_AutoCommit:
            {
              ...
              if (turnOnAC != 0 && iRollback != 0 && db.activeVdbeCnt > 1)
              {
                ...
                */
                //sqlite3SetString(ref p.zErrMsg, db, 
                p.zErrMsg = "cannot rollback transaction - SQL statements in progress";
                rc = SQLITE_BUSY;
              }
              ...
              {
                //sqlite3SetString(ref p.zErrMsg, db,
                p.zErrMsg = (0 == desiredAutoCommit) ? "cannot start a transaction within a transaction" : (
          ...
          case OP_AggFinal:
            {
              ...
              if (rc != 0)
              {
                ...
                p.zErrMsg = sqlite3_value_text(pMem);
              }
          ...
          case OP_Trace:
            {
              ...
              {
                sqlite3DebugPrintf("SQL-trace: {0}\n", zTrace);
              }
#endif // * SQLITE_DEBUG */
              break;
            }
...
*/
    ...
    */
    vdbe_error_halt:
      ...
      p.rc = rc;
      testcase(sqlite3GlobalConfig.xLog != null);
      sqlite3_log(rc, "statement aborts at {0}: [{1}] {2}",
      pc, p.zSql, p.zErrMsg);
      sqlite3VdbeHalt(p);
    ...
    ** top. */
    ...
    abort_due_to_error:
      ...
      if (rc != SQLITE_IOERR_NOMEM)
      {
        ...
        p.zErrMsg = string.Format("{0}", sqlite3ErrStr(rc));
      }
      goto vdbe_error_halt;
