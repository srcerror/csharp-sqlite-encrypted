...
static void TRACE(string format, params object[] args) { if (sqlite3BtreeTrace)  Debug.WriteLine(format, args); }
#else
...
)
{
  ...
  TRACE( "AUTOVACUUM: Moving {0} to free page {1} (ptr page {2} type {3})\n",
    ...
    do
    {
      ...
      if ( k == 0 && 0 == searchList )
      {
        ...
        ** allocated page */
        ...
        ppPage = pTrunk;
        pTrunk = null;
        TRACE( "ALLOCATE: {0} trunk - {1} free pages left\n", pPgno, n - 1 );
      }
      ...
      else if ( k > 0 )
      {
        ...
        if ( 0 == searchList || iPage == nearby )
        {
          int noContent;
          pPgno = iPage;
          TRACE( "ALLOCATE: {0} was leaf {1} of {2} on trunk {3}: {4} more free pages\n",
  ...
  else
  {
    ...
    ** end of the file */
    ...
    if ( pBt.autoVacuum && PTRMAP_ISPAGE( pBt, pBt.nPage ) )
    {
      ...
      */
      MemPage pPg = null;
      TRACE( "ALLOCATE: {0} from end of file (pointer-map page)\n", pPgno );
    ...
    TRACE( "ALLOCATE: {0} from end of file\n", pPgno );
  }
...
if (false)
  ...
  if ( nFree != 0 )
  {
    ...
    if ( nLeaf < (u32)pBt.usableSize / 4 - 8 )
    {
      ...
      */
      ...
      TRACE( "FREE-PAGE: {0} leaf on trunk page {1}\n", iPage, pTrunk.pgno );
      goto freepage_out;
    }
  }
  ...
  */
  ...
  TRACE( "FREE-PAGE: {0} new trunk page replacing {1}\n", pPage.pgno, iTrunk );
...
#if FALSE
TRACE("BALANCE: begin page {0} child of {1}\n", pPage.pgno, pParent.pgno);
#endif
...
ptrmapCheckPages(pParent, 1);
  ...
  TRACE( "BALANCE: finished: old={0} new={1} cells={2}\n", nOld, nNew, nCell );
...
if (false)
  ...
  TRACE( "BALANCE: copy root {0} into {1}\n", pRoot.pgno, pChild.pgno );
...
)
{
  ...
  */
  ...
  TRACE( "INSERT: table={0} nkey={1} ndata={2} page={3} {4}\n",
